...
namespace Canaa.Infra.ExternalServices.Whatsapp
{
    ...
    {
        public static async Task<string> SendMensage(SendTextMessageDataObjec request)
        {
            if (request == null)
            ...
            var dtoMessage = new SendTextMessageDataObjec
            {
                ...
                {
                    text = request.textMessage?.text ?? string.Empty
                }
            };
